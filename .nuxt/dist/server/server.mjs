...
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "E:/Project2026/compare-data/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/list-BWiC4KAU.js")
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import("./_nuxt/admin-DoLactuq.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DUI1LL9G.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-tIpRDvKn.js")
  },
  {
    name: "report",
    path: "/report",
    component: () => import("./_nuxt/report-fr-Kl507.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Dwax1hUJ.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Be3bplVU.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CkDhMP_0.js"));
