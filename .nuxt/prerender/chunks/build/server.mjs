import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, createApp, isVNode, createCommentVNode, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, Suspense, nextTick, Fragment, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive } from 'file://E:/Project2026/compare-data/node_modules/vue/index.mjs';
import { $fetch } from 'file://E:/Project2026/compare-data/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file://E:/Project2026/compare-data/node_modules/nuxt/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://E:/Project2026/compare-data/node_modules/h3/dist/index.mjs';
import { setActivePinia, createPinia, shouldHydrate } from 'file://E:/Project2026/compare-data/node_modules/pinia/dist/pinia.js';
import { defu } from 'file://E:/Project2026/compare-data/node_modules/defu/dist/defu.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://E:/Project2026/compare-data/node_modules/vue-router/vue-router.node.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://E:/Project2026/compare-data/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://E:/Project2026/compare-data/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./list-Dv3wmrJp.mjs')
  },
  {
    name: "admin",
    path: "/admin",
  ...
  },
  {
    ...
    component: () => import('./login-tIpRDvKn.mjs')
  },
  {
    name: "report",
    path: "/report",
    component: () => import('./report-DsXlrhCs.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Be3bplVU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CkDhMP_0.mjs'));
