globalThis.__timing__.logStart('Load chunks/build/default-Dwax1hUJ');import { _ as __nuxt_component_0 } from './nuxt-link-DIiCkb4O.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><button type="button">\u0E2D\u0E2D\u0E01\u0E08\u0E32\u0E01\u0E23\u0E30\u0E1A\u0E1A</button></nav></div></header>`);
...
export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/default-Dwax1hUJ');
//# sourceMappingURL=default-Dwax1hUJ.mjs.map
