globalThis.__timing__.logStart('Load chunks/build/report-CgsboPeg');import { _ as _sfc_main$1 } from './LegacyPanel-DJJ9u9fC.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "legacy-container content-page" }, _attrs))} data-v-8f3ca932><div class="workspace-grid report-workspace" data-v-8f3ca932><section class="main-column" data-v-8f3ca932>`);
      _push(ssrRenderComponent(_component_CommonLegacyPanel, { title: "\u0E04\u0E49\u0E19\u0E2B\u0E32:" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="report-search-form" data-v-8f3ca932${_scopeId}><div class="report-control-row" data-v-8f3ca932${_scopeId}><span class="input-prefix" data-v-8f3ca932${_scopeId}>\u0E10\u0E32\u0E19\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25:</span><select${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-8f3ca932${_scopeId}><!--[-->`);
            ssrRenderList(unref(projects), (project) => {
              _push2(`<option${ssrRenderAttr("value", project.id)} data-v-8f3ca932${ssrIncludeBooleanAttr(Array.isArray(unref(selectedProjectId)) ? ssrLooseContain(unref(selectedProjectId), project.id) : ssrLooseEqual(unref(selectedProjectId), project.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(project.displayName)}</option>`);
            });
            _push2(`<!--]--></select></div><div class="search-line" data-v-8f3ca932${_scopeId}><span class="input-prefix" data-v-8f3ca932${_scopeId}>Search By ID</span><input${ssrRenderAttr("value", unref(searchInput))}${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} placeholder="\u0E01\u0E23\u0E2D\u0E01\u0E23\u0E2B\u0E31\u0E2A\u0E17\u0E35\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32" data-v-8f3ca932${_scopeId}><div class="report-search-actions" data-v-8f3ca932${_scopeId}><button class="btn btn-gray" type="button"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-8f3ca932${_scopeId}>\u0E04\u0E49\u0E19\u0E2B\u0E32</button><button class="btn btn-danger" type="button"${ssrIncludeBooleanAttr(unref(loading) || !unref(appliedSearchId)) ? " disabled" : ""} data-v-8f3ca932${_scopeId}>\u0E25\u0E49\u0E32\u0E07\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32</button></div></div></div>`);
          } else {
            return [
      ...
      if (unref(loadError)) {
        _push(`<p class="error-text report-error" data-v-8f3ca932>${ssrInterpolate(unref(loadError))}</p>`);
      } else {
        _push(`<!---->`);
      }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(loading) && !unref(summaryTables).length) {
              _push2(`<div class="report-empty" data-v-8f3ca932${_scopeId}>\u0E01\u0E33\u0E25\u0E31\u0E07\u0E42\u0E2B\u0E25\u0E14\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19...</div>`);
            } else {
              _push2(`<div class="report-table-wrap" data-v-8f3ca932${_scopeId}><table class="report-summary-table" data-v-8f3ca932${_scopeId}><thead data-v-8f3ca932${_scopeId}><tr data-v-8f3ca932${_scopeId}><th data-v-8f3ca932${_scopeId}>${ssrInterpolate(unref(summaryFirstColumnLabel))}</th><th data-v-8f3ca932${_scopeId}>Round1<br data-v-8f3ca932${_scopeId}><small data-v-8f3ca932${_scopeId}>(\u0E08\u0E33\u0E19\u0E27\u0E19\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25)</small></th><th data-v-8f3ca932${_scopeId}>Round2<br data-v-8f3ca932${_scopeId}><small data-v-8f3ca932${_scopeId}>(\u0E08\u0E33\u0E19\u0E27\u0E19\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25)</small></th><th data-v-8f3ca932${_scopeId}>Compare<br data-v-8f3ca932${_scopeId}><small data-v-8f3ca932${_scopeId}>(\u0E08\u0E33\u0E19\u0E27\u0E19\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25)</small></th></tr></thead><tbody data-v-8f3ca932${_scopeId}><!--[-->`);
              ssrRenderList(unref(summaryTables), (table) => {
                _push2(`<tr data-v-8f3ca932${_scopeId}><td data-v-8f3ca932${_scopeId}>${ssrInterpolate(table.displayName)}</td><td data-v-8f3ca932${_scopeId}>${ssrInterpolate(formatNumber(table.round1Count))}</td><td data-v-8f3ca932${_scopeId}>${ssrInterpolate(formatNumber(table.round2Count))}</td><td data-v-8f3ca932${_scopeId}>${ssrInterpolate(formatNumber(table.compareCount))}</td></tr>`);
              });
              _push2(`<!--]-->`);
              if (!unref(summaryTables).length) {
                _push2(`<tr data-v-8f3ca932${_scopeId}><td colspan="4" data-v-8f3ca932${_scopeId}>\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23\u0E15\u0E32\u0E23\u0E32\u0E07\u0E17\u0E35\u0E48\u0E40\u0E1B\u0E34\u0E14 compare</td></tr>`);
              } else {
                _push2(`<!---->`);
              }
      ...
      _push(`<div class="report-result-copy" data-v-8f3ca932><p data-v-8f3ca932>\u0E08\u0E33\u0E19\u0E27\u0E19\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 ${ssrInterpolate(formatNumber(unref(summaryTotals).round1))} record</p><p data-v-8f3ca932>\u0E40\u0E1B\u0E23\u0E35\u0E22\u0E1A\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E41\u0E25\u0E49\u0E27 ${ssrInterpolate(formatNumber(unref(summaryTotals).compare))} record</p><p data-v-8f3ca932>\u0E04\u0E07\u0E40\u0E2B\u0E25\u0E37\u0E2D ${ssrInterpolate(formatNumber(unref(summaryTotals).remaining))} record</p><h2 data-v-8f3ca932>\u0E1C\u0E25\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32 : <strong data-v-8f3ca932>${ssrInterpolate(formatNumber(unref(pagination).from))}</strong> Of <strong data-v-8f3ca932>${ssrInterpolate(formatNumber(unref(pagination).total))}</strong> record</h2></div>`);
      _push(ssrRenderComponent(_component_CommonLegacyPanel, { title: "\u0E23\u0E32\u0E22\u0E07\u0E32\u0E19\u0E1C\u0E25 (\u0E15\u0E32\u0E23\u0E32\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25)" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="report-table-tools" data-v-8f3ca932${_scopeId}><label data-v-8f3ca932${_scopeId}> Show <select${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-8f3ca932${_scopeId}><option${ssrRenderAttr("value", 10)} data-v-8f3ca932${ssrIncludeBooleanAttr(Array.isArray(unref(limit)) ? ssrLooseContain(unref(limit), 10) : ssrLooseEqual(unref(limit), 10)) ? " selected" : ""}${_scopeId}>10</option><option${ssrRenderAttr("value", 25)} data-v-8f3ca932${ssrIncludeBooleanAttr(Array.isArray(unref(limit)) ? ssrLooseContain(unref(limit), 25) : ssrLooseEqual(unref(limit), 25)) ? " selected" : ""}${_scopeId}>25</option><option${ssrRenderAttr("value", 50)} data-v-8f3ca932${ssrIncludeBooleanAttr(Array.isArray(unref(limit)) ? ssrLooseContain(unref(limit), 50) : ssrLooseEqual(unref(limit), 50)) ? " selected" : ""}${_scopeId}>50</option><option${ssrRenderAttr("value", 100)} data-v-8f3ca932${ssrIncludeBooleanAttr(Array.isArray(unref(limit)) ? ssrLooseContain(unref(limit), 100) : ssrLooseEqual(unref(limit), 100)) ? " selected" : ""}${_scopeId}>100</option></select> entries </label><label data-v-8f3ca932${_scopeId}> Search: <input${ssrRenderAttr("value", unref(tableSearch))} placeholder="" data-v-8f3ca932${_scopeId}></label></div><div class="report-table-wrap report-data-scroll" data-v-8f3ca932${_scopeId}><table class="report-data-table" data-v-8f3ca932${_scopeId}><thead data-v-8f3ca932${_scopeId}><tr data-v-8f3ca932${_scopeId}><th data-v-8f3ca932${_scopeId}>ID</th><th data-v-8f3ca932${_scopeId}>\u0E1C\u0E39\u0E49\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 \u0E23\u0E2D\u0E1A1</th><th data-v-8f3ca932${_scopeId}>\u0E1C\u0E39\u0E49\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 \u0E23\u0E2D\u0E1A2</th><!--[-->`);
            ssrRenderList(unref(tableColumns), (table) => {
              _push2(`<th data-v-8f3ca932${_scopeId}>${ssrInterpolate(table.tableName)}</th>`);
            });
            _push2(`<!--]--></tr></thead><tbody data-v-8f3ca932${_scopeId}><!--[-->`);
            ssrRenderList(unref(visibleRows), (row) => {
              _push2(`<tr data-v-8f3ca932${_scopeId}><td data-v-8f3ca932${_scopeId}>${ssrInterpolate(row.id)}</td><td class="text-left" data-v-8f3ca932${_scopeId}>${ssrInterpolate(row.recp || "-")}</td><td class="text-left" data-v-8f3ca932${_scopeId}>${ssrInterpolate(row.recpr2 || "-")}</td><!--[-->`);
              ssrRenderList(unref(tableColumns), (table) => {
                var _a, _b, _c, _d, _e, _f;
                _push2(`<td data-v-8f3ca932${_scopeId}><span class="${ssrRenderClass(["report-status-icon", ((_b = (_a = row.tables) == null ? void 0 : _a[table.tableName]) == null ? void 0 : _b.tone) || "empty"])}"${ssrRenderAttr("title", ((_d = (_c = row.tables) == null ? void 0 : _c[table.tableName]) == null ? void 0 : _d.label) || "")} data-v-8f3ca932${_scopeId}>${ssrInterpolate(((_f = (_e = row.tables) == null ? void 0 : _e[table.tableName]) == null ? void 0 : _f.icon) || "--")}</span></td>`);
              });
              _push2(`<!--]--></tr>`);
            });
            _push2(`<!--]-->`);
            if (!unref(visibleRows).length) {
              _push2(`<tr data-v-8f3ca932${_scopeId}><td${ssrRenderAttr("colspan", 3 + unref(tableColumns).length)} data-v-8f3ca932${_scopeId}>\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E15\u0E32\u0E21\u0E40\u0E07\u0E37\u0E48\u0E2D\u0E19\u0E44\u0E02</td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="report-pagination" data-v-8f3ca932${_scopeId}><button type="button"${ssrIncludeBooleanAttr(unref(loading) || unref(pagination).page <= 1) ? " disabled" : ""} data-v-8f3ca932${_scopeId}>Previous</button><!--[-->`);
            ssrRenderList(unref(pageItems), (pageItem) => {
              _push2(`<button type="button"${ssrIncludeBooleanAttr(unref(loading) || pageItem.disabled) ? " disabled" : ""} class="${ssrRenderClass({ active: pageItem.value === unref(pagination).page, ellipsis: pageItem.ellipsis })}" data-v-8f3ca932${_scopeId}>${ssrInterpolate(pageItem.label)}</button>`);
            });
            _push2(`<!--]--><button type="button"${ssrIncludeBooleanAttr(unref(loading) || unref(pagination).page >= unref(totalPages)) ? " disabled" : ""} data-v-8f3ca932${_scopeId}>Next</button></div>`);
          } else {
            return [
                  ...
                  createVNode("tbody", null, [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(visibleRows), (row) => {
                      return openBlock(), createBlock("tr", {
                        ...
                        createVNode("td", { class: "text-left" }, toDisplayString(row.recp || "-"), 1),
                        createVNode("td", { class: "text-left" }, toDisplayString(row.recpr2 || "-"), 1),
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(tableColumns), (table) => {
                          var _a, _b, _c, _d, _e, _f;
                          return openBlock(), createBlock("td", {
                            ...
                            createVNode("span", {
                              class: ["report-status-icon", ((_b = (_a = row.tables) == null ? void 0 : _a[table.tableName]) == null ? void 0 : _b.tone) || "empty"],
      ...
      _push(`</section><aside class="side-column" data-v-8f3ca932>`);
      ...
      _push(ssrRenderComponent(_component_CommonLegacyPanel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ul class="legend-list" data-v-8f3ca932${_scopeId}><li data-v-8f3ca932${_scopeId}><span class="legend warning" data-v-8f3ca932${_scopeId}>\u25B2</span>\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E14\u0E33\u0E40\u0E19\u0E34\u0E19\u0E01\u0E32\u0E23 compare</li><li data-v-8f3ca932${_scopeId}><span class="legend ok" data-v-8f3ca932${_scopeId}>\u2713</span>Compare \u0E41\u0E25\u0E49\u0E27</li><li data-v-8f3ca932${_scopeId}><span class="legend error" data-v-8f3ca932${_scopeId}>\u2716</span>\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E23\u0E2D\u0E1A \u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E15\u0E23\u0E07\u0E01\u0E31\u0E19</li><li data-v-8f3ca932${_scopeId}><span class="legend slash" data-v-8f3ca932${_scopeId}>/</span>\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E23\u0E2D\u0E1A \u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E40\u0E17\u0E48\u0E32\u0E01\u0E31\u0E19</li><li data-v-8f3ca932${_scopeId}><span class="legend empty" data-v-8f3ca932${_scopeId}>--</span>\u0E44\u0E21\u0E48\u0E21\u0E35\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E2D\u0E07\u0E23\u0E2D\u0E1A</li></ul>`);
          } else {
            return [
...
const report = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8f3ca932"]]);

export { report as default };;globalThis.__timing__.logEnd('Load chunks/build/report-CgsboPeg');
//# sourceMappingURL=report-CgsboPeg.mjs.map
